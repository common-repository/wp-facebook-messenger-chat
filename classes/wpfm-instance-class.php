...
if ( !class_exists( 'WPFM_Instance_Class' ) ) {
	
	/**
	 * Example of an instance class
	 */
	class WPFM_Instance_Class
	{
		protected $foo, $bar;
		...
		public function __construct( $foo, $bar )
		{
			...
			$this->readable_protected_vars = ['foo', 'bar'];
			$this->writeable_protected_vars = ['foo'];
